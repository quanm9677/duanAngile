...
<div class="container py-4">
    ...
    <form action="{{ route('admin.comics.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" @if ($firstErrorField=='description' ) autofocus @endif>{{ old('description') }}</textarea>
            @if ($firstErrorField == 'description')
            <p class="alert alert-danger mt-1">{{ $errors->first('description') }}</p>
            @endif
        </div>
        <!-- Ngày Xuất Bản -->
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('publication_date') is-invalid @enderror"
                ...
                @if ($firstErrorField=='publication_date' ) autofocus @endif>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('price') is-invalid @enderror" id="price"
                name="price" value="{{ old('price') }}" @if ($firstErrorField=='price' ) autofocus @endif>
        ...
        <!-- <div class="mb-3">
                ...
                <input type="number" class="form-control @error('original_price') is-invalid @enderror" id="original_price"
                    ...
                    @if ($firstErrorField == 'original_price') autofocus @endif>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('stock_quantity') is-invalid @enderror" id="stock_quantity"
                ...
                @if ($firstErrorField=='stock_quantity' ) autofocus @endif>
